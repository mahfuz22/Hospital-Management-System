...
/**
 * Servlet implementation class ChangeStuffPass
 */
@WebServlet("/ChangeStuffPass")
public class ChangeStuffPass extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeStuffPass() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String sql="select password from stuff where email='"+userMail+"'";
			...
			if (ppass.equals(mainPass)) {
				String sql1="update stuff set password='"+nPass+"' where email='"+userMail+"'";
