...
/**
 * Servlet implementation class ChangeLabPass
 */
@WebServlet("/ChangeLabPass")
public class ChangeLabPass extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeLabPass() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String sql="select password from labrotorist where email='"+userMail+"'";
			...
			if (ppass.equals(mainPass)) {
				String sql1="update labrotorist set password='"+nPass+"' where email='"+userMail+"'";
