...
/**
 * Servlet implementation class UpdateBloodDonorByLab
 */
@WebServlet("/UpdateBloodDonorByLab")
public class UpdateBloodDonorByLab extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateBloodDonorByLab() {
        super();
