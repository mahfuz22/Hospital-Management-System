...
/**
 * Servlet implementation class ChangeDPass
 */
@WebServlet("/ChangeDPass")
public class ChangeDPass extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String sql="select password from doctor where email='"+userMail+"'";
			...
			if (ppass.equals(mainPass)) {
				String sql1="update doctor set password='"+nPass+"' where email='"+userMail+"'";
