...
/**
 * Servlet implementation class AddBedAllotmentByD
 */
@WebServlet("/AddBedAllotmentByD")
public class AddBedAllotmentByD extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddBedAllotmentByD() {
        super();
