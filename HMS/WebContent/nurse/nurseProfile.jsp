	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../nurse/editNProfile.jsp" method="post">
			  		<%
			  		String mail=session.getAttribute("userMail").toString();
			  		List<AddNurse> list=NurseDao.getRecordByEmail(mail);
			  		String name="";
			  		String email="";
			  		String address="";
			  		String phone="";
					for(AddNurse an:list) {
						name=an.getNurseName();
						email=an.getNurseEmail();
						address=an.getNurseAddress();
						phone=an.getNursePhone();
					}
			  		%>
			  		<div>
