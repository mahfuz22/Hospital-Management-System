	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../nurse/updateBed.jsp" method="post">
			  		
			  		<%
			  			int id=Integer.parseInt(request.getParameter("id"));
			  			List<Bed> list=BedDao.getBedNumberType(id);
			  			int bedNumber=0;
			  			String bedType="";
			  			int rate=0;
			  			for(Bed bed:list) {
			  				bedType=bed.getBedType();
			  				bedNumber=bed.getTotalBed();
			  				rate=bed.getRate();
			  			}
			  		%>
			  		<div>
			  		...
			  		<div>
			  			<input type="text" name="bedtype" value="<%=bedType %>" placeholder="Bed Type" />
			  		</div>
			  		<div>
			  			<input type="text" name="rate" value="<%=rate %>" placeholder="Rate"/>
			  		</div>
