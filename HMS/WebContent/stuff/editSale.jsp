	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  ...
			  <div class="adddep">
			  	<form id="form1" action="../stuff/updateSale.jsp" method="post">
			  		<%
			  			int id=Integer.parseInt(request.getParameter("id"));
			  			List<Sale> list=SaleDao.getRecordsById(id);
			  			String patientName="";
			  			double price=0;
			  			for(Sale s:list) {
			  		...
			  		%>
			  		<div>
			  			<input type="text" name="pateintname" value="<%=patientName %>"/>
			  			<input type="hidden" name="id" value="<%=id %>"/>
			  		</div>
			  		
			  		<div>
			  			<input type="text" name="price" value="<%=price %>" placeholder="Total Price"/>
			  		</div>
				  	...
				  	<div class="depbtn">
				  		<div class="btn-group">
						  <a href="javascript:;" onclick="document.getElementById('form1').submit();" class="btn btn-primary">Update Sale</a>
