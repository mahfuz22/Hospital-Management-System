	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../stuff/editSProfile.jsp" method="post">
			  		<%
			  		String mail=session.getAttribute("userMail").toString();
			  		List<AddStuff> list=StuffDao.getRecords();
			  		String name="";
			  		String email="";
			  		String address="";
			  		String phone="";
					for(AddStuff an:list) {
						name=an.getStuffName();
						email=an.getStuffEmail();
						address=an.getStuffAddress();
						phone=an.getStuffPhone();
					}
			  		%>
			  		<div>
			...
			<div id="Paris" class="tabcontent">
			  <div class="adddep">
			  	<form id="form" action="../stuff/changeStuffPass.jsp" method="post">
