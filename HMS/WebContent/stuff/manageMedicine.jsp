	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  	...
			  	<table>
			  		...
			  		<tbody>
			  			...
			  			<%
								...
								List<Medicine> baList=MedicineDao.getRecords(pageid, total);
								int count=0;
									for(Medicine ba:baList){%>
										<%
											count++;
											int id=ba.getId();
											String medicineName=ba.getMedicineName();
											String categoryName=ba.getCategory();
											String description=ba.getDescription();
											double price=ba.getPrice();
											String companyName=ba.getCompanyName();
											int status=(int)ba.getStatus();
										%>
										<tr>
							  				<td><%=count %></td>
							  				<td><p><%=medicineName %></p></td>
							  				...
							  				<td><p><%=status %></p></td>
							  				<td><div class="action">
													<abbr title="Delete"><a href="../stuff/deleteMedicine.jsp?id=<%=id %>"> <i class="fa fa-trash"></i></a></abbr>
													<abbr title="edit"><a href="../stuff/editMedicine.jsp?id=<%=id %>"> <i class="fa fa-pencil-square-o" ></i></a></abbr>
												</div>
											</td>
							  			</tr>
									<%} %>
			  ...
			  <div class="page">
			  	<a href="../stuff/manageMedicine.jsp?page=1">1</a>
				<a href="../stuff/manageMedicine.jsp?page=2">2</a>
				<a href="../stuff/manageMedicine.jsp?page=3">3</a>
				<a href="../stuff/manageMedicine.jsp?page=4">4</a>
				<a href="../stuff/manageMedicine.jsp?page=5">5</a>
				<a href="../stuff/manageMedicine.jsp?page=6">6</a>
			  </div>
			...
			<div id="Paris" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../stuff/addMedicine.jsp" method="post">
			  		<div>
			  			<input type="text" name="name" value="" placeholder="Medicine Name"/>
			  		</div>
			  		<div>
			  			<select class="selectpic" name="category">
								<option value="" selected>Select Category</option>
								<%
									List<MedicineCategory> list=MedicineCategoyDao.getCatagory();
									for(MedicineCategory mc:list) {%>
										<option value="<%=mc.getCategoryName()%>"><%=mc.getCategoryName()%></option>
									<%}
								%>
			  		...
			  		<div>
			  			<input type="text" name="company" value="" placeholder="Manufacturing Company"/>
			  		</div>
			  		<div>
				  	...
				  	<div class="depbtn">
				  		<div class="btn-group">
						  <a href="javascript:;" onclick="document.getElementById('form1').submit();" class="btn btn-primary">Add Medicine</a>
