	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="tabcon">
			  	<table>
			  		...
			  		<tbody>
			  			<%
			  				List<OperationType> list=OperationTypeDao.getRecords();
			  				int count=0;
			  				for(OperationType ot:list) {%>
			  				<%count++; %>
			  					<tr>
											
							  				<td><p><%=count %></p></td>
							  				<td><p><%=ot.getOperationtype() %></p></td>
							  				<td><p><%=ot.getFee() %></p></td>
							  				<td><p><%=ot.getDescription() %></p></td>
							  				<td><div class="action">
							  						<abbr title="delete"><a href="../doctor/deleteOperationType.jsp?id=<%=ot.getId()%>"> <i class="fa fa-trash" ></i></a></abbr>
												</div>
											</td>
							  			</tr>
			  				<%}
			...
			<div id="Paris" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../doctor/addOperationType.jsp" method="post">
			  		<div>
			  			<input type="text" name="operationtype" value="" placeholder="Operation type"/>
			  		</div>
			  		<div>
			  			<input type="email" name="operationfee" value="" placeholder="Operation Fee" required/>
			  		</div>
			  		<div>
