	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../admin/updateNotice.jsp" method="post">
			  		
			  		<%
			  		int id=Integer.parseInt(request.getParameter("id"));
			  		List<Notice> list=NoticeDao.getRecordsById(id);
			  		String sub="";
			  		String des="";
			  		String date="";
					for(Notice ap:list) {
						sub=ap.getSubject();
						des=ap.getDescription();
						date=ap.getDate();
			  		...
			  		<div class="areatext">
			  			<textarea rows="" cols="" name="subject" value="" placeholder="Case History"><%=sub %></textarea>
			  		</div>
			  		<div class="areatext">
			  			<textarea rows="" cols="" name="description" value="" placeholder="Case History"><%=des %></textarea>
			  		</div>
			  		<div>
			  			<input type="text" name="date" value="<%=date %>" placeholder="Case History">
			  		</div>
