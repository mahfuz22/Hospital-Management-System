	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../nurse/editNProfile.jsp" method="post" enctype="multipart/form-data">
			  		<%
			  		...
			  		<div>
			  			<label>Address :</label><input type="text" name="address" value="" placeholder="Address" />
			  		</div>
			  		<div>
			  			<label>phone :</label><input type="text" name="phone" value="" placeholder="Phone Number" />
			  		</div>
			  		<div>
			  			<label>photo :</label><input type="file" name="photo" size="50"/>
			  		</div>
			  		<div class="depbtn">
				  		<div class="btn-group">
						  <a href="javascript:;" onclick="document.getElementById('form1').submit();" class="btn btn-primary">Change Password</a>
			...
			<div id="Paris" class="tabcontent">
			  <div class="adddep">
			  	<form id="form" action="../nurse/changePass.jsp" method="post">
