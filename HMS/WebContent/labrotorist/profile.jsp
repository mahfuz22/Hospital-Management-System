	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../labrotorist/updateProfile.jsp" method="post">
			  		<%
			  		String mail=session.getAttribute("userMail").toString();
			  		List<Labrotorist> list=LabrotoristDao.getRecordsByMail(mail);
			  		String name="";
			  		String email="";
			  		String address="";
			  		String phone="";
					for(Labrotorist l:list) {
						name=l.getName();
						email=l.getEmail();
			...
			<div id="Paris" class="tabcontent">
			  <div class="adddep">
			  	<form id="form" action="../labrotorist/changePass.jsp" method="post">
