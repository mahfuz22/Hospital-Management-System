	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../labrotorist/updatePatientTest.jsp" method="post">
			  		<%
			  			int id=Integer.parseInt(request.getParameter("id"));
			  			List<TestPatient> list=TestPatientDao.getRecordsById(id);
			  			String patientName="";
			  			String testType="";
			  			double labFee=0;
			  			String date="";
			  			for(TestPatient t:list) {
			  		...
			  		<div>
			  			<select class="selectpic" name="type">
								<option value="<%=testType%>" selected><%=testType%></option>
								<%
									List<Test> list1=TestDao.getType();
									for(Test t:list1) {%>
			  		...
			  		<div>
			  			<input type="text" name="labfee" value="<%=labFee%>"/>
			  		</div>
			  		<div>
