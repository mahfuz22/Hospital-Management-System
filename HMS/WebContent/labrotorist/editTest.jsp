	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../labrotorist/updateTest.jsp" method="post">
			  		<%
			  			int id=Integer.parseInt(request.getParameter("id"));
			  			List<Test> list=TestDao.getRecordsById(id);
			  			String type="";
			  			double fee=0;
			  			String description="";
			  			for(Test t:list) {
			  		...
			  		<div>
			  			<input type="text" name="rate" value="<%=fee%>"/>
			  		</div>
			  		<div>
