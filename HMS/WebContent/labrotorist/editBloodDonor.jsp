	...
	<div class="container">
		<div>
			...
			<div id="London" class="tabcontent">
			  <div class="adddep">
			  	<form id="form1" action="../labrotorist/updateBloodDonor.jsp" method="post">
			  		<%
			  			List<BloodDonor> list=BloodDonorDao.getBloodDonorRecords();
			  			...
			  			String bloodGroup="";
			  			String lastDonation="";
			  			for(BloodDonor bd:list) {
			  				name=bd.getName();
			  				email=bd.getEmail();
			  				address=bd.getAddress();
			  				phone=bd.getPhoneNumber();
			  				sex=bd.getSex();
			  				age=bd.getAge();
			  				bloodGroup=bd.getBloodGroup();
			  				lastDonation=bd.getLastDonationDate();
			  			}
			  		%>
			  		<div>
			  			<input type="text" name="donorname" value="<%=name%>"/>
			  		...
			  		<div>
			  			<input type="date" name="lastdonation" value="<%=lastDonation%>" />
			  		</div>
